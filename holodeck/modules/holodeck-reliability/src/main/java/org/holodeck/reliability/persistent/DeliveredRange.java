 ...
 */
@Entity
@Table(name = "Delivered_Ranges")
public class DeliveredRange extends MessageRange
{
  @Id @GeneratedValue(generator="system-uuid")
  @GenericGenerator(name="system-uuid", strategy="uuid")
  @Column(name = "DeliveredRange_ID")
...
//  protected String groupId;
  ...
  public DeliveredRange(String groupId, int min, int max)
  {
