...
{
//  private static final Log log = LogFactory.getLog(ReliabilityProcessing.class.getName());
  private static final Logger log = Logger.getLogger(ReliabilityProcessing.class.getName());
