 ...
 * The Class EnvelopeE.
 */
public class EnvelopeE implements org.apache.axis2.databinding.ADBBean {
	
	/** The Constant MY_QNAME. */
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://schemas.xmlsoap.org/soap/envelope/", "Envelope", "ns2");
	...
	/** The local envelope. */
	protected org.xmlsoap.schemas.soap.envelope.Envelope localEnvelope;
	 ...
	 */
	public void setEnvelope(org.xmlsoap.schemas.soap.envelope.Envelope param) {
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			{
				EnvelopeE.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/envelope/",
										"Envelope").equals(reader.getName())) {
							object.setEnvelope(org.xmlsoap.schemas.soap.envelope.Envelope.Factory.parse(reader));
