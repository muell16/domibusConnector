 ...
 * The Class FaultE.
 */
public class FaultE implements org.apache.axis2.databinding.ADBBean {
	
	/** The Constant MY_QNAME. */
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://schemas.xmlsoap.org/soap/envelope/", "Fault", "ns2");
	...
	/** The local fault. */
	protected org.xmlsoap.schemas.soap.envelope.Fault localFault;
	 ...
	 */
	public void setFault(org.xmlsoap.schemas.soap.envelope.Fault param) {
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			{
				FaultE.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement()
							...
							object.setFault(org.xmlsoap.schemas.soap.envelope.Fault.Factory.parse(reader));
