...
public class Fault3 implements org.apache.axis2.databinding.ADBBean {
	...
	/** The local detail. */
	protected org.w3.www._2003._05.soap_envelope.DetailE localDetail;
	/*
	 * This tracker boolean wil be used to detect whether the user called the set method for this attribute. It will be
	 * used to determine whether to include this field in the serialized XML
	 */
	 ...
	 * @return the detail
	 */
	public org.w3.www._2003._05.soap_envelope.DetailE getDetail() {
		return localDetail;
	}
	 ...
	 */
	public void setDetail(org.w3.www._2003._05.soap_envelope.DetailE param) {
		if (param != null) {
			//update the setting tracker
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Fault".equals(type)) {
							...
							return (Fault3) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.w3.org/2003/05/soap-envelope", "Detail")
								.equals(reader.getName())) {
					object.setDetail(org.w3.www._2003._05.soap_envelope.DetailE.Factory.parse(reader));
					reader.next();
				} // End of if for expected property start element
				else {
				}
