 ...
 * The Class Header1.
 */
public class Header1 implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Header Namespace URI =
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
			...
			{
				Header1.this.serialize(parentQName, factory, xmlWriter);
			}
		};
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Header",
						xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Header", xmlWriter);
			}
		}
		if (localExtraAttributes != null) {
	...
	public static class Factory {
		 ...
		 */
		public static Header1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			Header1 object = new Header1();
			int event;
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Header".equals(type)) {
							...
							return (Header1) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
