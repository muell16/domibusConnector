 ...
 * The Class Upgrade.
 */
public class Upgrade implements org.apache.axis2.databinding.ADBBean {
	
	/** The Constant MY_QNAME. */
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.w3.org/2003/05/soap-envelope", "Upgrade", "ns3");
	...
	/** The local upgrade. */
	protected org.w3.www._2003._05.soap_envelope.UpgradeType localUpgrade;
	 ...
	 * @return the upgrade
	 */
	public org.w3.www._2003._05.soap_envelope.UpgradeType getUpgrade() {
		return localUpgrade;
	}
	 ...
	 * Sets the upgrade.
	 *
	 * @param param the new upgrade
	 */
	public void setUpgrade(org.w3.www._2003._05.soap_envelope.UpgradeType param) {
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			{
				Upgrade.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		localUpgrade.serialize(MY_QNAME, factory, xmlWriter);
	}
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement()
							...
							object.setUpgrade(org.w3.www._2003._05.soap_envelope.UpgradeType.Factory.parse(reader));
