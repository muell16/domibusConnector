 ...
 * The Class DetailE.
 */
public class DetailE implements org.apache.axis2.databinding.ADBBean {
	/*
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
			...
			{
				DetailE.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public static class Factory {
		 ...
		 */
		public static DetailE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			DetailE object = new DetailE();
			int event;
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"detail".equals(type)) {
							...
							return (DetailE) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
