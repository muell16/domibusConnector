...
/**
 * The Class SupportedEnvType.
 */
public class SupportedEnvType implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = SupportedEnvType Namespace URI =
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
			...
			{
				SupportedEnvType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"SupportedEnvType".equals(type)) {
							...
							return (SupportedEnvType) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
					}
				}
