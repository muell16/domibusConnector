 ...
 * The Class Envelope4.
 */
public class Envelope4 implements org.apache.axis2.databinding.ADBBean {
	
	/** The Constant MY_QNAME. */
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.w3.org/2003/05/soap-envelope", "Envelope", "ns3");
	...
	/** The local envelope. */
	protected org.w3.www._2003._05.soap_envelope.Envelope0 localEnvelope;
	 ...
	 * @return the envelope
	 */
	public org.w3.www._2003._05.soap_envelope.Envelope0 getEnvelope() {
	 ...
	 * Sets the envelope.
	 *
	 * @param param the new envelope
	 */
	public void setEnvelope(org.w3.www._2003._05.soap_envelope.Envelope0 param) {
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			{
				Envelope4.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public static class Factory {
		 ...
		 *
		 * @param reader the reader
		 * @return the envelope4
		 * @throws Exception the exception
		 */
		public static Envelope4 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			Envelope4 object = new Envelope4();
			int event;
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement()
							...
							object.setEnvelope(org.w3.www._2003._05.soap_envelope.Envelope0.Factory.parse(reader));
