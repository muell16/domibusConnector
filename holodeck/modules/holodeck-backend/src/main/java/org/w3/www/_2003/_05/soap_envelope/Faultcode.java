...
public class Faultcode implements org.apache.axis2.databinding.ADBBean {
	...
	/** The local value. */
	protected org.w3.www._2003._05.soap_envelope.FaultcodeEnum localValue;
	/*
	 ...
	 */
	public void setValue(org.w3.www._2003._05.soap_envelope.FaultcodeEnum param) {
		if (param != null) {
		...
		public static Faultcode parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"faultcode".equals(type)) {
							...
							return (Faultcode) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement()
					...
					object.setValue(org.w3.www._2003._05.soap_envelope.FaultcodeEnum.Factory.parse(reader));
					reader.next();
