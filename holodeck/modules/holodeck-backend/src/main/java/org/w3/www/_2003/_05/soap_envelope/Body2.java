 ...
 * The Class Body2.
 */
public class Body2 implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Body Namespace URI =
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
			...
			{
				Body2.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public static class Factory {
		 ...
		 */
		public static Body2 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			Body2 object = new Body2();
			int event;
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Body".equals(type)) {
							...
							return (Body2) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
