...
/**
 * The Class NotUnderstoodType.
 */
public class NotUnderstoodType implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = NotUnderstoodType Namespace URI =
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
			...
			{
				NotUnderstoodType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":NotUnderstoodType", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "NotUnderstoodType",
						xmlWriter);
			}
		}
		if (localQname != null) {
			writeQNameAttribute("", "qname", localQname, xmlWriter);
		} else {
	...
	public static class Factory {
		...
		public static NotUnderstoodType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"NotUnderstoodType".equals(type)) {
							...
							return (NotUnderstoodType) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
					}
				}
				...
				java.lang.String tempAttribQname = reader.getAttributeValue(null, "qname");
				if (tempAttribQname != null) {
					...
					object.setQname(org.apache.axis2.databinding.utils.ConverterUtil.convertToQName(tempAttribQname,
							namespaceuri));
				} else {
