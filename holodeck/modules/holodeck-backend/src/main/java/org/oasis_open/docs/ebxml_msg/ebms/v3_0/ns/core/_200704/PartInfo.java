...
public class PartInfo implements org.apache.axis2.databinding.ADBBean {
	 ...
	 */
	public void setSchema(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Schema param) {
		if (param != null) {
	 ...
	 */
	public void setPartProperties(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.PartProperties param) {
		if (param != null) {
			//update the setting tracker
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (localSchemaTracker) {
			...
			localSchema.serialize(new javax.xml.namespace.QName(
					"http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "Schema"), factory, xmlWriter);
		}
		...
		public static PartInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.isStartElement()
					...
					object.setSchema(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Schema.Factory
							.parse(reader));
					reader.next();
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "PartProperties")
								.equals(reader.getName())) {
					object.setPartProperties(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.PartProperties.Factory
							.parse(reader));
					reader.next();
				} // End of if for expected property start element
				else {
