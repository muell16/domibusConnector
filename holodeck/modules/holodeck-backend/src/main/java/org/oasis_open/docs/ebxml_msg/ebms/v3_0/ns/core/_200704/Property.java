 ...
 * The Class Property.
 */
public class Property extends org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.NonEmptyString implements
	...
	/** The local name. */
	protected org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.NonEmptyString localName;
	 ...
	 * @return the name
	 */
	public org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.NonEmptyString getName() {
		return localName;
	}
	 ...
	 */
	public void setName(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.NonEmptyString param) {
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Property",
					xmlWriter);
		} else {
	...
	public static class Factory {
		 ...
		 * @return the property
		 */
		public static Property fromString(javax.xml.stream.XMLStreamReader xmlStreamReader, java.lang.String content) {
		...
		public static Property parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Property".equals(type)) {
							...
							return (Property) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (tempAttribName != null) {
					...
					object.setName(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.NonEmptyString.Factory
							.fromString(reader, tempAttribName));
				} else {
