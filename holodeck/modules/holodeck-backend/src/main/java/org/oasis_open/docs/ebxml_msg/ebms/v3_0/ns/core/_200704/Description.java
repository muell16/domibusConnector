 ...
 */
public class Description extends org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.NonEmptyString implements
	...
	/** The local lang. */
	protected org.w3.www.xml._1998.namespace.Lang_type0 localLang;
	 ...
	 * @return the lang
	 */
	public org.w3.www.xml._1998.namespace.Lang_type0 getLang() {
		return localLang;
	}
	 ...
	 */
	public void setLang(org.w3.www.xml._1998.namespace.Lang_type0 param) {
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					namespacePrefix + ":Description", xmlWriter);
		} else {
		...
		public static Description parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Description".equals(type)) {
							...
							return (Description) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (tempAttribLang != null) {
					...
					object.setLang(org.w3.www.xml._1998.namespace.Lang_type0.Factory.fromString(reader, tempAttribLang));
				} else {
				}
