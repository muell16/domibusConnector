 ...
 * The Class Service.
 */
public class Service extends org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.NonEmptyString implements
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Service",
					xmlWriter);
		} else {
	...
	public static class Factory {
		 ...
		 * @return the service
		 */
		public static Service fromString(javax.xml.stream.XMLStreamReader xmlStreamReader, java.lang.String content) {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Service".equals(type)) {
							...
							return (Service) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
