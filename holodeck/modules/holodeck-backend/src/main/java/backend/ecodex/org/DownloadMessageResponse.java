...
/**
 * The Class DownloadMessageResponse.
 */
public class DownloadMessageResponse implements org.apache.axis2.databinding.ADBBean {
	 ...
	 */
	protected void validatePayload(javax.activation.DataHandler[] param) {
	}

	/**
	 * Sets the payload.
	 *
	 * @param param the new payload
	 */
	 ...
	 * @param param the param
	 */
	public void addPayload(javax.activation.DataHandler param) {
		if (localPayload == null) {
			localPayload = new javax.activation.DataHandler[] {};
		}
		//update the setting tracker
		localPayloadTracker = true;
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localPayload);
		list.add(param);
		this.localPayload = (javax.activation.DataHandler[]) list
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			{
				DownloadMessageResponse.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":downloadMessageResponse", xmlWriter);
			} else {
		...
		if (localPayloadTracker) {
			if (localPayload != null) {
				...
				for (int i = 0; i < localPayload.length; i++) {
					if (localPayload[i] != null) {
						if (!emptyNamespace) {
							if (prefix == null) {
								java.lang.String prefix2 = generatePrefix(namespace);
								xmlWriter.writeStartElement(prefix2, "payload", namespace);
						...
						xmlWriter.writeDataHandler(localPayload[i]);
				...
				for (int i = 0; i < localPayload.length; i++) {
					if (localPayload[i] != null) {
						...
						elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localPayload[i]));
					} else {
						// have to do nothing
					}
				}
	...
	public static class Factory {
		 ...
		 *
		 * @param reader the reader
		 * @return the download message response
		 * @throws Exception the exception
		 */
		public static DownloadMessageResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
		{
			DownloadMessageResponse object = new DownloadMessageResponse();
			int event;
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"downloadMessageResponse".equals(type)) {
							...
							return (DownloadMessageResponse) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "payload").equals(reader.getName())) {
					...
					if (isReaderMTOMAware(reader)
						...
						if (reader.getEventType() == javax.xml.stream.XMLStreamConstants.START_ELEMENT
								&& new javax.xml.namespace.QName("", "payload").equals(reader.getName())) {
							reader.next();
						}
						if (reader.getEventType() == javax.xml.stream.XMLStreamConstants.START_ELEMENT
							...
							list1.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToBase64Binary(content));
							reader.next();
						}
					}
									...
									if (reader.getEventType() == javax.xml.stream.XMLStreamConstants.START_ELEMENT
											&& reader.getName().equals(
													new javax.xml.namespace.QName(
															org.apache.axiom.om.impl.MTOMConstants.XOP_NAMESPACE_URI,
															org.apache.axiom.om.impl.MTOMConstants.XOP_INCLUDE))) {
										java.lang.String id = org.apache.axiom.om.util.ElementHelper.getContentID(
												reader, "UTF-8");
										list1.add(((org.apache.axiom.soap.impl.builder.MTOMStAXSOAPModelBuilder) ((org.apache.axiom.om.impl.llom.OMStAXWrapper) reader)
												.getBuilder()).getDataHandler(id));
										reader.next();
					...
					object.setPayload((javax.activation.DataHandler[]) org.apache.axis2.databinding.utils.ConverterUtil
