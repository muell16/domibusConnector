...
public class FaultDetail implements org.apache.axis2.databinding.ADBBean {
	...
	/** The local code. */
	protected backend.ecodex.org.Code localCode;
	/*
	 ...
	 * @return the code
	 */
	public backend.ecodex.org.Code getCode() {
		return localCode;
	}
	 ...
	 */
	public void setCode(backend.ecodex.org.Code param) {
		if (param != null) {
		...
		public static FaultDetail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "code").equals(reader.getName())) {
					object.setCode(backend.ecodex.org.Code.Factory.parse(reader));
					reader.next();
