...
public class Code implements org.apache.axis2.databinding.ADBBean {
	 ...
	 */
	protected Code(java.lang.String value, boolean isRegisterValue) {
	...
	public static final Code ERROR_GENERAL_001 = new Code(_ERROR_GENERAL_001, true);
	
	/** The Constant ERROR_GENERAL_002. */
	public static final Code ERROR_GENERAL_002 = new Code(_ERROR_GENERAL_002, true);
	
	/** The Constant ERROR_GENERAL_003. */
	public static final Code ERROR_GENERAL_003 = new Code(_ERROR_GENERAL_003, true);
	
	/** The Constant ERROR_SEND_001. */
	public static final Code ERROR_SEND_001 = new Code(_ERROR_SEND_001, true);
	
	/** The Constant ERROR_SEND_002. */
	public static final Code ERROR_SEND_002 = new Code(_ERROR_SEND_002, true);
	
	/** The Constant ERROR_SEND_003. */
	public static final Code ERROR_SEND_003 = new Code(_ERROR_SEND_003, true);
	
	/** The Constant ERROR_SEND_004. */
	public static final Code ERROR_SEND_004 = new Code(_ERROR_SEND_004, true);
	
	/** The Constant ERROR_DOWNLOAD_001. */
	public static final Code ERROR_DOWNLOAD_001 = new Code(_ERROR_DOWNLOAD_001, true);
	
	/** The Constant ERROR_DOWNLOAD_002. */
	public static final Code ERROR_DOWNLOAD_002 = new Code(_ERROR_DOWNLOAD_002, true);
	
	/** The Constant ERROR_DOWNLOAD_003. */
	public static final Code ERROR_DOWNLOAD_003 = new Code(_ERROR_DOWNLOAD_003, true);
	...
	public static class Factory {
		 ...
		 */
		public static Code fromValue(java.lang.String value) throws java.lang.IllegalArgumentException {
			Code enumeration = (Code) _table_.get(value);
			if (enumeration == null)
		 ...
		 * @throws IllegalArgumentException the illegal argument exception
		 */
		public static Code fromString(java.lang.String value, java.lang.String namespaceURI)
		 ...
		 * @return the code
		 */
		public static Code fromString(javax.xml.stream.XMLStreamReader xmlStreamReader, java.lang.String content)
		{
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement() || reader.hasText()) {
						...
						if (content.indexOf(":") > 0) {
							...
							object = Code.Factory.fromString(content, namespaceuri);
						} else {
							// this seems to be not a qname send and empty namespace incase of it is
							// check is done in fromString method
							object = Code.Factory.fromString(content, "");
						}
					} else {
						reader.next();
					}
