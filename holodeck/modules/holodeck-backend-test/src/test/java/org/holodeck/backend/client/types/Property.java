 ...
 * The Class Property.
 */
public class Property extends NonEmptyString implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Property Namespace URI =
	...
	/** The local name. */
	protected NonEmptyString localName;
	 ...
	 * Sets the name.
	 *
	 * @param param the new name
	 */
	public void setName(NonEmptyString param) {
	...
	public static class Factory {
		 ...
		 * @return the property
		 */
		public static Property fromString(java.lang.String value, java.lang.String namespaceURI) {
		...
		public static Property
				fromString(javax.xml.stream.XMLStreamReader xmlStreamReader, java.lang.String content)
		{
			if (content.indexOf(":") > -1) {
				java.lang.String prefix = content.substring(0, content.indexOf(":"));
				java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
				return Property.Factory.fromString(content, namespaceUri);
			} else {
				return Property.Factory.fromString(content, "");
			}
		}
		...
		public static Property parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (tempAttribName != null) {
					...
					object.setName(NonEmptyString.Factory.fromString(reader, tempAttribName));
				} else {
