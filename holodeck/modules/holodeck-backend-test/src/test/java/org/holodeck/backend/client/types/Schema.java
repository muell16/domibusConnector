...
public class Schema implements org.apache.axis2.databinding.ADBBean {
	...
	/** The local namespace. */
	protected NonEmptyString localNamespace;
	 ...
	 */
	public NonEmptyString getNamespace() {
	 ...
	 */
	public void setNamespace(NonEmptyString param) {
		...
		public static Schema parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Schema".equals(type)) {
							...
							return (Schema) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (tempAttribVersion != null) {
					...
					object.setVersion(NonEmptyString.Factory.fromString(reader, tempAttribVersion));
				} else {
				}
				...
				if (tempAttribNamespace != null) {
					...
					object.setNamespace(NonEmptyString.Factory.fromString(reader, tempAttribNamespace));
				} else {
				}
