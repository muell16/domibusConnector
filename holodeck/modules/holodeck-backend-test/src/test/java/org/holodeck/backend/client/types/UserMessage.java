...
public class UserMessage implements org.apache.axis2.databinding.ADBBean {
	 ...
	 */
	public void setPartyInfo(PartyInfo param) {
		if (param != null) {
			//update the setting tracker
	...
	protected CollaborationInfo localCollaborationInfo;
	/*
	 * This tracker boolean wil be used to detect whether the user called the set method for this attribute. It will
	 * be used to determine whether to include this field in the serialized XML
	 */
	 ...
	 */
	public void setCollaborationInfo(CollaborationInfo param) {
		if (param != null) {
			//update the setting tracker
	...
	protected MessageProperties localMessageProperties;
	/*
	 * This tracker boolean wil be used to detect whether the user called the set method for this attribute. It will
	 * be used to determine whether to include this field in the serialized XML
	 */
	 ...
	 */
	public void setMessageProperties(MessageProperties param) {
		if (param != null) {
			//update the setting tracker
	 ...
	 */
	public void setPayloadInfo(PayloadInfo param) {
		if (param != null) {
			//update the setting tracker
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (localPartyInfoTracker) {
			...
			localPartyInfo.serialize(new javax.xml.namespace.QName(
					"http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "PartyInfo"), factory,
					xmlWriter);
		}
		...
		public static UserMessage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"UserMessage".equals(type)) {
							...
							return (UserMessage) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement()
					...
					object.setCollaborationInfo(CollaborationInfo.Factory.parse(reader));
					reader.next();
				} // End of if for expected property start element
				else {
				}
				...
				if (reader.isStartElement()
					...
					object.setMessageProperties(MessageProperties.Factory.parse(reader));
					reader.next();
				} // End of if for expected property start element
				else {
				}
