 ...
 * The Class Faultcode.
 */
public class Faultcode implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = faultcode Namespace URI =
	...
	/** The local value. */
	protected FaultcodeEnum localValue;
	/*
	 ...
	 */
	public void setValue(FaultcodeEnum param) {
		if (param != null) {
	...
	/** The local subcode. */
	protected Subcode localSubcode;
	/*
	 * This tracker boolean wil be used to detect whether the user called the set method for this attribute. It will
	 * be used to determine whether to include this field in the serialized XML
	 */
	 ...
	 */
	public void setSubcode(Subcode param) {
		if (param != null) {
			//update the setting tracker
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
			...
			{
				Faultcode.this.serialize(parentQName, factory, xmlWriter);
			}
		};
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "faultcode", xmlWriter);
			}
		}
		...
		if (localSubcodeTracker) {
			...
			localSubcode.serialize(new javax.xml.namespace.QName("http://www.w3.org/2003/05/soap-envelope",
					"Subcode"), factory, xmlWriter);
		}
	...
	public static class Factory {
		...
		public static Faultcode parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			Faultcode object = new Faultcode();
			int event;
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"faultcode".equals(type)) {
							...
							return (Faultcode) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement()
					...
					object.setValue(FaultcodeEnum.Factory.parse(reader));
					reader.next();
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.w3.org/2003/05/soap-envelope", "Subcode")
								.equals(reader.getName())) {
					object.setSubcode(Subcode.Factory.parse(reader));
					reader.next();
				} // End of if for expected property start element
				else {
				}
