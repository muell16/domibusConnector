...
public class DownloadMessageResponse implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://org.ecodex.backend/1_0/", "downloadMessageResponse", "ns1");
	...
	public static class Factory {
		 ...
		 */
		public static DownloadMessageResponse parse(javax.xml.stream.XMLStreamReader reader)
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"downloadMessageResponse".equals(type)) {
							...
							return (DownloadMessageResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
