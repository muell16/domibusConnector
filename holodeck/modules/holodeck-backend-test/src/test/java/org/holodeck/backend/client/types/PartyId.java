 ...
 * The Class PartyId.
 */
public class PartyId extends NonEmptyString implements org.apache.axis2.databinding.ADBBean {
	/*
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					namespacePrefix + ":PartyId", xmlWriter);
		} else {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"PartyId".equals(type)) {
							...
							return (PartyId) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
