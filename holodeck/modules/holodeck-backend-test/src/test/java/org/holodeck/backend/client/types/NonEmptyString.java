...
public class NonEmptyString implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * Sets the non empty string.
	 *
	 * @param param the new non empty string
	 */
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			{
				NonEmptyString.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public static class Factory {
		 ...
		 * @return the non empty string
		 */
		public static NonEmptyString fromString(java.lang.String value, java.lang.String namespaceURI) {
		...
		public static NonEmptyString parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			NonEmptyString object = new NonEmptyString();
			int event;
