 ...
 * The Class Service.
 */
public class Service extends NonEmptyString implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Service Namespace URI =
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			...
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Service", xmlWriter);
		}
		if (localType != null) {
	...
	public static class Factory {
		 ...
		 * @return the service
		 */
		public static Service fromString(java.lang.String value, java.lang.String namespaceURI) {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Service".equals(type)) {
							...
							return (Service) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
