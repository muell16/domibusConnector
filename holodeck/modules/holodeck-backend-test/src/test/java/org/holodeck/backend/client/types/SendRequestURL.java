...
/**
 * The Class SendRequestURL.
 */
public class SendRequestURL implements org.apache.axis2.databinding.ADBBean {

	/** The Constant MY_QNAME. */
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://org.ecodex.backend/1_0/", "sendRequestURL", "ns1");
	 ...
	 */
	protected void validatePayload(java.lang.String[] param) {
	}
	 ...
	 * @param param the param
	 */
	public void addPayload(java.lang.String param) {
		if (localPayload == null) {
			localPayload = new java.lang.String[] {};
		}
		//update the setting tracker
		localPayloadTracker = true;
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localPayload);
		list.add(param);
		this.localPayload = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
	}
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			{
				SendRequestURL.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":sendRequestURL", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "sendRequestURL",
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 *
		 * @param reader the reader
		 * @return the send request url
		 * @throws Exception the exception
		 */
		public static SendRequestURL parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			SendRequestURL object = new SendRequestURL();
			int event;
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"sendRequestURL".equals(type)) {
							//find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (SendRequestURL) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement()
					...
					object.setPayload((java.lang.String[]) list1.toArray(new java.lang.String[list1.size()]));
