...
public class PullRequest implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = PullRequest Namespace URI =
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
			...
			{
				PullRequest.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public static class Factory {
		 ...
		 */
		public static PullRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			PullRequest object = new PullRequest();
			int event;
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"PullRequest".equals(type)) {
							...
							return (PullRequest) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
