...
public class Envelope0 implements org.apache.axis2.databinding.ADBBean {
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (localHeaderTracker) {
			...
			localHeader.serialize(
					new javax.xml.namespace.QName("http://www.w3.org/2003/05/soap-envelope", "Header"), factory,
					xmlWriter);
		}
		if (localBodyTracker) {
			if (localBody == null) {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Envelope".equals(type)) {
							...
							return (Envelope0) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
