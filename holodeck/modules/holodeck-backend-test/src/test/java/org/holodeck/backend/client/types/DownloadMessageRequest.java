...
public class DownloadMessageRequest implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://org.ecodex.backend/1_0/", "downloadMessageRequest", "ns1");
	...
	public static class Factory {
		 ...
		 */
		public static DownloadMessageRequest parse(javax.xml.stream.XMLStreamReader reader)
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"downloadMessageRequest".equals(type)) {
							...
							return (DownloadMessageRequest) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
