...
public class FaultcodeEnum implements org.apache.axis2.databinding.ADBBean {
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "faultcodeEnum",
						xmlWriter);
			}
		}
	...
	public static class Factory {
		...
		{
			try {
				return fromValue(org.apache.axis2.databinding.utils.ConverterUtil.convertToQName(value,
						namespaceURI));
