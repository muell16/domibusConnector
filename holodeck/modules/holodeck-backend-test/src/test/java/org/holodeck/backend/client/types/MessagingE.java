...
public class MessagingE implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * Sets the messaging.
	 *
	 * @param param the new messaging
	 */
	public void setMessaging(Messaging param) {
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			{
				MessagingE.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		localMessaging.serialize(MY_QNAME, factory, xmlWriter);
	}
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName(
										...
										"Messaging").equals(reader.getName())) {
							object.setMessaging(Messaging.Factory.parse(reader));
