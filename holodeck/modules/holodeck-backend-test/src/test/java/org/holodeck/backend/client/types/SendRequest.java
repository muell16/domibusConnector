...
public class SendRequest implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://org.ecodex.backend/1_0/", "sendRequest", "ns1");
	...
	public void addPayload(javax.activation.DataHandler param) {
		...
		list.add(param);
		this.localPayload = (javax.activation.DataHandler[]) list.toArray(new javax.activation.DataHandler[list
				.size()]);
	}
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"sendRequest".equals(type)) {
							...
							return (SendRequest) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
