...
/**
 * The Class ListPendingMessagesResponse.
 */
public class ListPendingMessagesResponse implements org.apache.axis2.databinding.ADBBean {

	/** The Constant MY_QNAME. */
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://org.ecodex.backend/1_0/", "listPendingMessagesResponse", "ns1");
	...
	public void addMessageID(java.lang.String param) {
		...
		//update the setting tracker
		localMessageIDTracker = true;
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localMessageID);
		list.add(param);
		this.localMessageID = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
	}
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			{
				ListPendingMessagesResponse.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":listPendingMessagesResponse", xmlWriter);
			} else {
					...
					if (localMessageID[i] != null) {
						if (!emptyNamespace) {
							if (prefix == null) {
								...
								xmlWriter.writeStartElement(prefix2, "messageID", namespace);
						...
						xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localMessageID[i]));
	...
	public static class Factory {
		 ...
		 */
		public static ListPendingMessagesResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception
		{
			ListPendingMessagesResponse object = new ListPendingMessagesResponse();
			int event;
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"listPendingMessagesResponse".equals(type)) {
							//find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (ListPendingMessagesResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement()
					...
					object.setMessageID((java.lang.String[]) list1.toArray(new java.lang.String[list1.size()]));
