...
public class PartInfo implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = PartInfo Namespace URI =
	 ...
	 * Sets the schema.
	 *
	 * @param param the new schema
	 */
	public void setSchema(Schema param) {
		if (param != null) {
			//update the setting tracker
			localSchemaTracker = true;
		} else {
			localSchemaTracker = false;
		}
		this.localSchema = param;
	}

	/** The local description. */
	protected Description localDescription;
	/*
	 * This tracker boolean wil be used to detect whether the user called the set method for this attribute. It will
	 * be used to determine whether to include this field in the serialized XML
	 */
	 ...
	 */
	public void setDescription(Description param) {
		if (param != null) {
			//update the setting tracker
	...
	/** The local part properties. */
	protected PartProperties localPartProperties;
	/*
	 * This tracker boolean wil be used to detect whether the user called the set method for this attribute. It will
	 * be used to determine whether to include this field in the serialized XML
	 */
	/** The local part properties tracker. */
	...
	/**
	 * Sets the part properties.
	 *
	 * @param param the new part properties
	 */
	public void setPartProperties(PartProperties param) {
		if (param != null) {
			//update the setting tracker
			localPartPropertiesTracker = true;
		} else {
			localPartPropertiesTracker = false;
		}
	 ...
	 * Sets the href.
	 *
	 * @param param the new href
	 */
	public void setHref(org.apache.axis2.databinding.types.Token param) {
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
			...
			{
				PartInfo.this.serialize(parentQName, factory, xmlWriter);
			}
		};
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (localSchemaTracker) {
			...
			localSchema
					.serialize(new javax.xml.namespace.QName(
							"http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "Schema"), factory,
							xmlWriter);
		}
		...
		if (localPartPropertiesTracker) {
			...
			localPartProperties.serialize(new javax.xml.namespace.QName(
					"http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "PartProperties"), factory,
					xmlWriter);
		}
			...
			throws org.apache.axis2.databinding.ADBException
	{
		...
		if (localSchemaTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "Schema"));
			if (localSchema == null) {
				throw new org.apache.axis2.databinding.ADBException("Schema cannot be null!!");
			}
		...
		if (localPartPropertiesTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "PartProperties"));
			if (localPartProperties == null) {
				throw new org.apache.axis2.databinding.ADBException("PartProperties cannot be null!!");
			}
	...
	public static class Factory {
		 ...
		 */
		public static PartInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			PartInfo object = new PartInfo();
			int event;
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"PartInfo".equals(type)) {
							...
							return (PartInfo) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				java.lang.String tempAttribHref = reader.getAttributeValue(null, "href");
				...
				if (reader.isStartElement()
					...
					object.setSchema(Schema.Factory.parse(reader));
					reader.next();
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "Description")
								.equals(reader.getName())) {
					object.setDescription(Description.Factory.parse(reader));
					reader.next();
				} // End of if for expected property start element
				else {
				}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "PartProperties")
								.equals(reader.getName())) {
					object.setPartProperties(PartProperties.Factory.parse(reader));
					reader.next();
				} // End of if for expected property start element
				else {
				}
