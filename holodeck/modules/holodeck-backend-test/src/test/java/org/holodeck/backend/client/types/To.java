 ...
 * The Class To.
 */
public class To implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = To Namespace URI =
	...
	/** The local party id. */
	protected PartyId[] localPartyId;
	/*
	 ...
	 */
	protected void validatePartyId(PartyId[] param) {
	}
	 ...
	 */
	public void setPartyId(PartyId[] param) {
	 ...
	 * @param param the param
	 */
	public void addPartyId(PartyId param) {
		if (localPartyId == null) {
			localPartyId = new PartyId[] {};
		}
		//update the setting tracker
		localPartyIdTracker = true;
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localPartyId);
		list.add(param);
		this.localPartyId = (PartyId[]) list.toArray(new PartyId[list.size()]);
	}
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
			...
			{
				To.this.serialize(parentQName, factory, xmlWriter);
			}
		};
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":To",
						xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "To", xmlWriter);
			}
		}
		...
		public static To parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"To".equals(type)) {
							...
							return (To) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement()
					...
					list1.add(PartyId.Factory.parse(reader));
					...
					object.setPartyId((PartyId[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
							PartyId.class, list1));
