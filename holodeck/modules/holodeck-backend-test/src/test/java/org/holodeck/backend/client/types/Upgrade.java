...
public class Upgrade implements org.apache.axis2.databinding.ADBBean {
	...
	/** The local upgrade. */
	protected UpgradeType localUpgrade;
	 ...
	 */
	public void setUpgrade(UpgradeType param) {
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://www.w3.org/2003/05/soap-envelope",
										"Upgrade").equals(reader.getName())) {
							object.setUpgrade(UpgradeType.Factory.parse(reader));
