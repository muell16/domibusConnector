 ...
 */
public class Description extends NonEmptyString implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Description Namespace URI =
			...
			final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException
	{
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
			...
			{
				Description.this.serialize(parentQName, factory, xmlWriter);
			}
		};
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			...
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Description", xmlWriter);
		}
		if (localLang != null) {
	...
	public static class Factory {
		 ...
		 * @return the description
		 */
		public static Description fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Description".equals(type)) {
							...
							return (Description) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
