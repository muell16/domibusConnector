			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (localOrigin != null) {
			writeAttribute("", "origin",
					org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOrigin), xmlWriter);
		}
	...
	public static class Factory {
		...
		public static Error parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				java.lang.String tempAttribRefToMessageInError = reader.getAttributeValue(null,
						"refToMessageInError");
				...
				if (tempAttribOrigin != null) {
					...
					object.setOrigin(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToToken(tempAttribOrigin));
				} else {
				}
