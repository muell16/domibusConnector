...
public class Faultreason implements org.apache.axis2.databinding.ADBBean {
	...
	/** The local text. */
	protected Reasontext[] localText;
	/*
	 ...
	 */
	protected void validateText(Reasontext[] param) {
	}
	 ...
	 */
	public void setText(Reasontext[] param) {
		validateText(param);
		if (param != null) {
	 ...
	 * @param param the param
	 */
	public void addText(Reasontext param) {
		if (localText == null) {
			localText = new Reasontext[] {};
		}
		//update the setting tracker
		localTextTracker = true;
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localText);
		list.add(param);
		this.localText = (Reasontext[]) list.toArray(new Reasontext[list.size()]);
	}
		...
		if (localTextTracker) {
			if (localText != null) {
				for (int i = 0; i < localText.length; i++) {
					if (localText[i] != null) {
						localText[i].serialize(new javax.xml.namespace.QName(
								"http://www.w3.org/2003/05/soap-envelope", "Text"), factory, xmlWriter);
					} else {
		...
		public static Faultreason parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"faultreason".equals(type)) {
							...
							return (Faultreason) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement()
					...
					list1.add(Reasontext.Factory.parse(reader));
					...
					object.setText((Reasontext[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
							Reasontext.class, list1));
