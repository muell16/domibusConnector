...
public class SaveToFolder implements EbConsumer
{
  ...
  {
    System.out.println("======================= SaveToFolder Consumer ===================");
  ...
  private String getSaveLocation(String mpc)
  {
    ...
    if ( mpc.startsWith("http://") ) mpc = mpc.substring(7);
    mpc = mpc.replaceAll(":", "-");
    mpc = mpc.replaceAll("/", "_");
    if ( dir == null || dir.trim().equals("") )
         dir = "Messages_" + mpc + File.separator + "Msg_" + getDate();
    else dir = dir + "_" + mpc + File.separator + "Msg_" + getDate();
  ...
  private void writeAttachments(MessageContext msgCtx,
                                List<PartInfo> parts, String location)
  {
