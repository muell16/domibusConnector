			...
			throws JAXBException
	{
		if (spocsContext == null) {
			spocsContext = JAXBContext
					.newInstance(org.etsi.uri._02640.v2.ObjectFactory.class, org.etsi.uri._02640.soapbinding.v1.ObjectFactory.class);
		}
		return spocsContext;
	}
			...
			throws JAXBException
	{
		if (soapContext == null) {
			soapContext = JAXBContext
					.newInstance(org.etsi.uri._02640.soapbinding.v1.ObjectFactory.class);
		}
		return soapContext;
	}
