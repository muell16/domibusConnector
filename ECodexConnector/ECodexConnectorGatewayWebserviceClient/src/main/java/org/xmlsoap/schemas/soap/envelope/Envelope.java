...
public class Envelope implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * Namespace URI = http://schemas.xmlsoap.org/soap/envelope/ Namespace
	 * Prefix = ns2
	 */
	...
	protected org.xmlsoap.schemas.soap.envelope.Header localHeader;
	 ...
	 * 
	 * @return org.xmlsoap.schemas.soap.envelope.Header
	 */
	 ...
	 *            Header
	 */
	public void setHeader(org.xmlsoap.schemas.soap.envelope.Header param) {
	...
	protected org.xmlsoap.schemas.soap.envelope.Body localBody;

	/**
	 * Auto generated getter method
	 * 
	 * @return org.xmlsoap.schemas.soap.envelope.Body
	 */
	 ...
	 *            Body
	 */
	public void setBody(org.xmlsoap.schemas.soap.envelope.Body param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (localHeaderTracker) {
			...
			localHeader.serialize(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/envelope/", "Header"),
			        xmlWriter);
		}
		if (localBody == null) {
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		if (localHeaderTracker) {
			elementList.add(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/envelope/", "Header"));
		...
		elementList.add(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/envelope/", "Body"));
		...
		public static Envelope parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				for (int i = 0; i < reader.getAttributeCount(); i++) {
					if (!handledAttributes.contains(reader.getAttributeLocalName(i))) {
						...
						org.apache.axiom.om.OMAttribute attr = factory.createOMAttribute(reader
						        .getAttributeLocalName(i), factory.createOMNamespace(reader.getAttributeNamespace(i),
						        reader.getAttributePrefix(i)), reader.getAttributeValue(i));
				...
				if (reader.isStartElement()
					...
					object.setHeader(org.xmlsoap.schemas.soap.envelope.Header.Factory.parse(reader));
				...
				if (reader.isStartElement()
					...
					object.setBody(org.xmlsoap.schemas.soap.envelope.Body.Factory.parse(reader));
