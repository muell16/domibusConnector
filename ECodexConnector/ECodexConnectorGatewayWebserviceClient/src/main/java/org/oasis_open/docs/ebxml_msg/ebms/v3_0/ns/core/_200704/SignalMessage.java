...
public class SignalMessage implements org.apache.axis2.databinding.ADBBean {
	 ...
	 *            PullRequest
	 */
	public void setPullRequest(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.PullRequest param) {
	 ...
	 *            Receipt
	 */
	public void setReceipt(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Receipt param) {
	 ...
	 */
	protected void validateError(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Error[] param) {
	 ...
	 *            Error
	 */
	public void setError(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Error[] param) {
	 ...
	 */
	public void addError(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Error param) {
		if (localError == null) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		localMessageInfo.serialize(new javax.xml.namespace.QName(
		        "http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "MessageInfo"), xmlWriter);
		if (localPullRequestTracker) {
			...
			localPullRequest.serialize(new javax.xml.namespace.QName(
			        "http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "PullRequest"), xmlWriter);
		}
		if (localReceiptTracker) {
			...
			localReceipt.serialize(new javax.xml.namespace.QName(
			        "http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "Receipt"), xmlWriter);
		}
		...
		public static SignalMessage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.isStartElement()
					...
					object.setPullRequest(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.PullRequest.Factory
					        .parse(reader));
				...
				if (reader.isStartElement()
					...
					object.setReceipt(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Receipt.Factory
					        .parse(reader));
				...
				if (reader.isStartElement()
					...
					object.setError((org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Error[]) org.apache.axis2.databinding.utils.ConverterUtil
					        .convertToArray(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Error.class, list4));
