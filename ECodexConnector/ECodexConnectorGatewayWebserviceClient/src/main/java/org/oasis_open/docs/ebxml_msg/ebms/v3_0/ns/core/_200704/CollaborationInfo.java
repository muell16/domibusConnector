...
public class CollaborationInfo implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * CollaborationInfo Namespace URI =
	 ...
	 *            AgreementRef
	 */
	public void setAgreementRef(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.AgreementRef param) {
	 ...
	 *            Service
	 */
	public void setService(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Service param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (localAgreementRefTracker) {
			...
			localAgreementRef.serialize(new javax.xml.namespace.QName(
			        "http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "AgreementRef"), xmlWriter);
		}
		...
		localService.serialize(new javax.xml.namespace.QName(
		        "http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "Service"), xmlWriter);
		...
		public static CollaborationInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"CollaborationInfo".equals(type)) {
							...
							return (CollaborationInfo) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type,
							        reader);
						}
				...
				if (reader.isStartElement()
					...
					object.setAgreementRef(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.AgreementRef.Factory
					        .parse(reader));
				...
				if (reader.isStartElement()
					...
					object.setService(org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.Service.Factory
					        .parse(reader));
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException("The element: " + "Action"
						        + "  cannot be null");
					}
				...
				if (reader.isStartElement()
					...
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException("The element: " + "ConversationId"
						        + "  cannot be null");
					}
