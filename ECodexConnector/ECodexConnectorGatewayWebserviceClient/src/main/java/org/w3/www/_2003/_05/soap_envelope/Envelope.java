...
public class Envelope implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * Namespace URI = http://www.w3.org/2003/05/soap-envelope Namespace Prefix
	 * = ns3
	 */
	...
	protected org.w3.www._2003._05.soap_envelope.Header localHeader;
	 ...
	 *            Header
	 */
	public void setHeader(org.w3.www._2003._05.soap_envelope.Header param) {
	...
	protected org.w3.www._2003._05.soap_envelope.Body localBody;
	 ...
	 *            Body
	 */
	public void setBody(org.w3.www._2003._05.soap_envelope.Body param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		localBody
		        .serialize(new javax.xml.namespace.QName("http://www.w3.org/2003/05/soap-envelope", "Body"), xmlWriter);
		...
		public static Envelope parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.isStartElement()
					...
					object.setHeader(org.w3.www._2003._05.soap_envelope.Header.Factory.parse(reader));
				...
				if (reader.isStartElement()
					...
					object.setBody(org.w3.www._2003._05.soap_envelope.Body.Factory.parse(reader));
