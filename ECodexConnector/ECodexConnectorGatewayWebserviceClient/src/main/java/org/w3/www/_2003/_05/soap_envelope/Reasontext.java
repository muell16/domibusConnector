...
public class Reasontext implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * reasontext Namespace URI = http://www.w3.org/2003/05/soap-envelope
	...
	public static class Factory {
		...
		public static Reasontext fromString(javax.xml.stream.XMLStreamReader xmlStreamReader, java.lang.String content) {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"reasontext".equals(type)) {
							...
							return (Reasontext) backend.ecodex.org.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					...
					if (reader.isStartElement() || reader.hasText()) {
						...
						if (reader.isStartElement() || reader.hasText()) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								throw new org.apache.axis2.databinding.ADBException("The element: " + "string"
								        + "  cannot be null");
							}
