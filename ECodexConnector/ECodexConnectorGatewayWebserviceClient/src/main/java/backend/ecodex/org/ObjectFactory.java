 ...
 * generated in the backend.ecodex.org package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListPendingMessagesRequest_QNAME = new QName("http://org.ecodex.backend", "listPendingMessagesRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: backend.ecodex.org
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.ecodex.backend", name = "listPendingMessagesRequest")
