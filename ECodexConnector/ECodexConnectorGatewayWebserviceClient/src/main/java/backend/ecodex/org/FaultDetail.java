...
public class FaultDetail implements org.apache.axis2.databinding.ADBBean {
	...
	protected backend.ecodex.org.Code_type1 localCode;

	/**
	 * Auto generated getter method
	 * 
	 * @return backend.ecodex.org.Code_type1
	 */
	public backend.ecodex.org.Code_type1 getCode() {
		return localCode;
	}
	 ...
	 *            Code
	 */
	public void setCode(backend.ecodex.org.Code_type1 param) {
		...
		public static FaultDetail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "code").equals(reader.getName())) {
					...
					object.setCode(backend.ecodex.org.Code_type1.Factory.parse(reader));
