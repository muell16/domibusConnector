...
public class SendRequest implements org.apache.axis2.databinding.ADBBean {
	...
	/**
	 * field for Payload This was an Array!
	 */
	...
	/**
	 * validate the array for Payload
	 */
					...
					if (localPayload[i] != null) {
						...
						try {
							org.apache.axiom.util.stax.XMLStreamWriterUtils.writeDataHandler(xmlWriter,
							        localPayload[i], null, true);
						} catch (java.io.IOException ex) {
							throw new javax.xml.stream.XMLStreamException("Unable to read data handler for payload["
							        + i + "]", ex);
						}
