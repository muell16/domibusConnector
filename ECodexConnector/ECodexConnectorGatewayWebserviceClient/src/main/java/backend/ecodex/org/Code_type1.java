...
public class Code_type1 implements org.apache.axis2.databinding.ADBBean {
	...
	protected Code_type1(java.lang.String value, boolean isRegisterValue) {
	...
	public static final Code_type1 ERROR_GENERAL_001 = new Code_type1(_ERROR_GENERAL_001, true);

	public static final Code_type1 ERROR_GENERAL_002 = new Code_type1(_ERROR_GENERAL_002, true);

	public static final Code_type1 ERROR_GENERAL_003 = new Code_type1(_ERROR_GENERAL_003, true);

	public static final Code_type1 ERROR_SEND_001 = new Code_type1(_ERROR_SEND_001, true);

	public static final Code_type1 ERROR_SEND_002 = new Code_type1(_ERROR_SEND_002, true);

	public static final Code_type1 ERROR_SEND_003 = new Code_type1(_ERROR_SEND_003, true);

	public static final Code_type1 ERROR_SEND_004 = new Code_type1(_ERROR_SEND_004, true);

	public static final Code_type1 ERROR_DOWNLOAD_001 = new Code_type1(_ERROR_DOWNLOAD_001, true);

	public static final Code_type1 ERROR_DOWNLOAD_002 = new Code_type1(_ERROR_DOWNLOAD_002, true);

	public static final Code_type1 ERROR_DOWNLOAD_003 = new Code_type1(_ERROR_DOWNLOAD_003, true);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "code_type1", xmlWriter);
			}
		}

		if (localCode_type0 == null) {

			throw new org.apache.axis2.databinding.ADBException("code_type0 cannot be null !!");
	...
	public static class Factory {
		...
		public static Code_type1 fromValue(java.lang.String value) throws java.lang.IllegalArgumentException {
			Code_type1 enumeration = (Code_type1)
		...
		public static Code_type1 fromString(java.lang.String value, java.lang.String namespaceURI)
		...
		public static Code_type1 fromString(javax.xml.stream.XMLStreamReader xmlStreamReader, java.lang.String content) {
			if (content.indexOf(":") > -1) {
				java.lang.String prefix = content.substring(0, content.indexOf(":"));
				java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
				return Code_type1.Factory.fromString(content, namespaceUri);
			} else {
				return Code_type1.Factory.fromString(content, "");
			}
		}
		 ...
		 * outer element
		 */
		public static Code_type1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			Code_type1 object = null;
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement() || reader.hasText()) {
						...
						if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
							throw new org.apache.axis2.databinding.ADBException("The element: " + "code_type0"
							        + "  cannot be null");
						}
						...
						if (content.indexOf(":") > 0) {
							...
							object = Code_type1.Factory.fromString(content, namespaceuri);
						} else {
							// this seems to be not a qname send and empty
							// namespace incase of it is
							// check is done in fromString method
							object = Code_type1.Factory.fromString(content, "");
						}
