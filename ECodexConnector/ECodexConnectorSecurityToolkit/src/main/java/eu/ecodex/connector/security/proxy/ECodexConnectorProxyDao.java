package eu.ecodex.connector.security.proxy;
...
public class ECodexConnectorProxyDao implements ProxyDao {

    private final Map<ProxyKey, String> values = new HashMap<ProxyKey, String>();

    public ECodexConnectorProxyDao(String proxyEnabled, String proxyHost, String proxyPort, String proxyUser,
