...
public class MessageFilter implements IMessageFilter {
     ...
     * 
     * @see
     * eu.ecodex.webadmin.blogic.impl.IMessageFilter#filterByFromParty(java.
     ...
     * 
     * @see
     * eu.ecodex.webadmin.blogic.impl.IMessageFilter#filterByToParty(java.lang
     ...
     * 
     * @see
     * eu.ecodex.webadmin.blogic.impl.IMessageFilter#filterByDirection(java.
     * lang.String, java.util.List)
     */
    @Override
     ...
     * 
     * @see
     * eu.ecodex.webadmin.blogic.impl.IMessageFilter#filterByStatus(java.lang
     * .String, java.util.List)
     */
    @Override
     ...
     * 
     * @see
     * eu.ecodex.webadmin.blogic.impl.IMessageFilter#filterByService(java.lang
     * .String, java.util.List)
     */
    @Override
     ...
     * 
     * @see
     * eu.ecodex.webadmin.blogic.impl.IMessageFilter#filterByAction(java.lang
     * .String, java.util.List)
     */
    @Override
     ...
     * 
     * @see
     * eu.ecodex.webadmin.blogic.impl.IMessageFilter#filterByLastEvidence(java
     * .lang.String, java.util.List)
     */
    @Override
