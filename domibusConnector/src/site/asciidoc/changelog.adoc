...
== 4.x.JTA_EXPERIMENTAL

=== 4.x.JTA_EXPERIMENTAL initial

==== Features

* High Availability Support, with JTA and JMS Queues
** Shared FS required
** HA JMS required (jms driver with XA support)
** HA DB required (jdbc driver with XA support)
