...
[source,properties]
----
include::{prdir}/domibusConnectorController/src/test/resources-filtered/config/application-routing-rule-test.properties[]
----
...
[source]
----
include::{prdir}/domibusConnectorController/src/main/java/eu/domibus/connector/controller/routing/RoutingRulePattern.java[tag=BNF]
----
