...
[source,properties]
----
include::../../../../domibusConnectorController/src/test/resources-filtered/config/application-routing-rule-test.properties[]
----
...
[source]
----
include::../../../../domibusConnectorController/src/main/java/eu/domibus/connector/controller/routing/RoutingRulePattern.java[tag=BNF]
----
