...
[source,properties]
----
include::{prdir}/domibusConnectorLinkCommon/src/test/resources/application-gwwspullplugin-test.properties[]
----
...
[source,properties]
----
include::{prdir}/domibusConnectorLinkCommon/src/test/resources/application-gwwspushplugin-test.properties[]
----
...
[source,properties]
----
include::{prdir}/domibusConnectorLinkCommon/src/test/resources/application-wsbackendplugin-test.properties[]
----
