@echo off
rem This is the automatically built startup script for the ECodexStandaloneConnector.
...
rem Check and get ECodexStandaloneConnector jar for call
set "ECDXCONNJAR=bin\ECodexConnectorRunnable.jar"
...
title "ECodexStandaloneConnector"
