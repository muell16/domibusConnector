...
public interface DCAuthenticationBasedTechnicalValidationServiceFactory {
    ...
    ECodexTechnicalValidationService createTechnicalValidationService(DomibusConnectorMessage message, DCEcodexContainerProperties.AuthenticationValidationConfigurationProperties config);
