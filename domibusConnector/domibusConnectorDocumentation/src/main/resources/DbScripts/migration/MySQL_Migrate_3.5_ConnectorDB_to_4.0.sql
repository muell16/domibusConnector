...
--  Changeset db/changelog/v004/upgrade-3to4.xml::3to4_upgrade_021_fk_create_msg_cont_cont_type::StephanSpindler
ALTER TABLE connectormigrate.DOMIBUS_CONNECTOR_MSG_CONT ADD CONSTRAINT FK_DOMIBUS_CONN_DOMIBUS_CON_03 FOREIGN KEY (CONTENT_TYPE) REFERENCES connectormigrate.DOMIBUS_CONNECTOR_CONT_TYPE (MESSAGE_CONTENT_TYPE) ON UPDATE NO ACTION ON DELETE NO ACTION;

INSERT INTO connectormigrate.DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('3to4_upgrade_021_fk_create_msg_cont_cont_type', 'StephanSpindler', 'db/changelog/v004/upgrade-3to4.xml', NOW(), 100, '7:4c93a2196fccac74ca8f3683a749552c', 'addForeignKeyConstraint baseTableName=DOMIBUS_CONNECTOR_MSG_CONT, constraintName=FK_DOMIBUS_CONN_DOMIBUS_CON_03, referencedTableName=DOMIBUS_CONNECTOR_CONT_TYPE', '', 'EXECUTED', NULL, NULL, '3.5.3', '3518077608');
