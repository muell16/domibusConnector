...
ALTER TABLE domibus_connector_evidences DROP FOREIGN KEY domibus_connector_evidences_ibfk_1;
ALTER TABLE domibus_connector_message_info DROP FOREIGN KEY domibus_connector_message_info_ibfk_1;
ALTER TABLE domibus_connector_message_info DROP FOREIGN KEY domibus_connector_message_info_ibfk_2;
ALTER TABLE domibus_connector_message_info DROP FOREIGN KEY domibus_connector_message_info_ibfk_2;
ALTER TABLE domibus_connector_message_info DROP FOREIGN KEY domibus_connector_message_info_ibfk_3;
ALTER TABLE domibus_connector_message_info DROP FOREIGN KEY domibus_connector_message_info_ibfk_3;
ALTER TABLE domibus_connector_message_info DROP FOREIGN KEY domibus_connector_message_info_ibfk_4;
ALTER TABLE domibus_connector_message_info DROP FOREIGN KEY domibus_connector_message_info_ibfk_5;
ALTER TABLE domibus_connector_msg_error DROP FOREIGN KEY domibus_connector_msg_error_ibfk_1;
...
ALTER TABLE DOMIBUS_CONNECTOR_SERVICE MODIFY SERVICE VARCHAR(255);
ALTER TABLE DOMIBUS_CONNECTOR_SERVICE MODIFY SERVICE_TYPE VARCHAR(512);

ALTER TABLE DOMIBUS_CONNECTOR_PARTY MODIFY PARTY_ID VARCHAR(255);
ALTER TABLE DOMIBUS_CONNECTOR_PARTY MODIFY ROLE VARCHAR(255);
ALTER TABLE DOMIBUS_CONNECTOR_PARTY MODIFY PARTY_ID_TYPE VARCHAR(512);


ALTER TABLE DOMIBUS_CONNECTOR_MSG_ERROR MODIFY ID numeric(10, 0);
...
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE_INFO MODIFY ID numeric(10, 0);
...
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGES RENAME DOMIBUS_CONNECTOR_MESSAGE;
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE ADD PRIMARY KEY (ID);
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE MODIFY ID numeric(10, 0);
...
ALTER TABLE DOMIBUS_CONNECTOR_EVIDENCES RENAME DOMIBUS_CONNECTOR_EVIDENCE;
ALTER TABLE DOMIBUS_CONNECTOR_EVIDENCE ADD PRIMARY KEY (ID);
ALTER TABLE DOMIBUS_CONNECTOR_EVIDENCE MODIFY ID numeric(10, 0);
...
ALTER TABLE DOMIBUS_CONNECTOR_ACTION MODIFY ACTION VARCHAR(255);
...
ALTER TABLE DOMIBUS_WEBADMIN_USER MODIFY USERNAME VARCHAR(512);
...
ALTER TABLE DOMIBUS_WEBADMIN_PROPERTIES RENAME DOMIBUS_WEBADMIN_PROPERTY;
ALTER TABLE DOMIBUS_WEBADMIN_PROPERTY CHANGE PROPERTIES_KEY `KEY` VARCHAR(512);
ALTER TABLE DOMIBUS_WEBADMIN_PROPERTY MODIFY `KEY` VARCHAR(512);
