...
CREATE TABLE DOMIBUS_WEBADMIN_USER (USERNAME VARCHAR(512) NOT NULL, PASSWORD VARCHAR(512) NOT NULL, SALT VARCHAR(255) NOT NULL, ROLE VARCHAR(255) NOT NULL);
...
CREATE TABLE DOMIBUS_WEBADMIN_PROPERTY (`KEY` VARCHAR(512) NULL, VALUE VARCHAR(512) NULL);
...
ALTER TABLE DCON_QRTZ_TRIGGERS ADD PRIMARY KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
...
ALTER TABLE DCON_QRTZ_TRIGGERS ADD CONSTRAINT fk_sched_to_job_details FOREIGN KEY (SCHED_NAME, JOB_NAME, JOB_GROUP) REFERENCES DCON_QRTZ_JOB_DETAILS (SCHED_NAME, JOB_NAME, JOB_GROUP);
...
CREATE TABLE DCON_QRTZ_SIMPLE_TRIGGERS (SCHED_NAME VARCHAR(120) NOT NULL, TRIGGER_NAME VARCHAR(200) NOT NULL, TRIGGER_GROUP VARCHAR(200) NOT NULL, REPEAT_COUNT BIGINT NOT NULL, REPEAT_INTERVAL BIGINT NOT NULL, TIMES_TRIGGERED BIGINT NOT NULL);
...
ALTER TABLE DCON_QRTZ_SIMPLE_TRIGGERS ADD PRIMARY KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
...
ALTER TABLE DCON_QRTZ_SIMPLE_TRIGGERS ADD CONSTRAINT fk_schedtrigger_qrtz_trig FOREIGN KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP) REFERENCES DCON_QRTZ_TRIGGERS (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
...
CREATE TABLE DCON_QRTZ_CRON_TRIGGERS (SCHED_NAME VARCHAR(120) NOT NULL, TRIGGER_NAME VARCHAR(200) NOT NULL, TRIGGER_GROUP VARCHAR(200) NOT NULL, CRON_EXPRESSION VARCHAR(120) NOT NULL, TIME_ZONE_ID VARCHAR(80) NULL);
...
ALTER TABLE DCON_QRTZ_CRON_TRIGGERS ADD PRIMARY KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
...
ALTER TABLE DCON_QRTZ_CRON_TRIGGERS ADD CONSTRAINT fk_crontrig_to_qrtztrig FOREIGN KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP) REFERENCES DCON_QRTZ_TRIGGERS (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
...
CREATE TABLE DCON_QRTZ_SIMPROP_TRIGGERS (SCHED_NAME VARCHAR(120) NOT NULL, TRIGGER_NAME VARCHAR(200) NOT NULL, TRIGGER_GROUP VARCHAR(200) NOT NULL, STR_PROP_1 VARCHAR(512) NULL, STR_PROP_2 VARCHAR(512) NULL, STR_PROP_3 VARCHAR(512) NULL, INT_PROP_1 INT NULL, INT_PROP_2 INT NULL, LONG_PROP_1 BIGINT NULL, LONG_PROP_2 BIGINT NULL, DEC_PROP_1 DECIMAL(13, 4) NULL, DEC_PROP_2 DECIMAL(13, 4) NULL, BOOL_PROP_1 VARCHAR(5) NULL, BOOL_PROP_2 VARCHAR(5) NULL);
...
ALTER TABLE DCON_QRTZ_SIMPROP_TRIGGERS ADD PRIMARY KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
...
ALTER TABLE DCON_QRTZ_SIMPROP_TRIGGERS ADD CONSTRAINT fk_simproptrig_to_qrtztrig FOREIGN KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP) REFERENCES DCON_QRTZ_TRIGGERS (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
...
CREATE TABLE DCON_QRTZ_BLOB_TRIGGERS (SCHED_NAME VARCHAR(120) NOT NULL, TRIGGER_NAME VARCHAR(200) NOT NULL, TRIGGER_GROUP VARCHAR(200) NOT NULL, BLOB_DATA BLOB NULL);
...
ALTER TABLE DCON_QRTZ_BLOB_TRIGGERS ADD PRIMARY KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
...
ALTER TABLE DCON_QRTZ_BLOB_TRIGGERS ADD CONSTRAINT fk_blobtrig_to_trig FOREIGN KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP) REFERENCES DCON_QRTZ_TRIGGERS (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
...
CREATE TABLE DCON_QRTZ_CALENDARS (SCHED_NAME VARCHAR(120) NOT NULL, CALENDAR_NAME VARCHAR(200) NOT NULL, CALENDAR BLOB NOT NULL);
...
ALTER TABLE DCON_QRTZ_CALENDARS ADD PRIMARY KEY (SCHED_NAME, CALENDAR_NAME);
...
CREATE TABLE DCON_QRTZ_PAUSED_TRIGGER_GRPS (SCHED_NAME VARCHAR(120) NOT NULL, TRIGGER_GROUP VARCHAR(200) NOT NULL);
...
ALTER TABLE DCON_QRTZ_PAUSED_TRIGGER_GRPS ADD PRIMARY KEY (SCHED_NAME, TRIGGER_GROUP);
...
ALTER TABLE DCON_QRTZ_FIRED_TRIGGERS ADD PRIMARY KEY (SCHED_NAME, ENTRY_ID);
...
CREATE TABLE DCON_QRTZ_SCHEDULER_STATE (SCHED_NAME VARCHAR(120) NOT NULL, INSTANCE_NAME VARCHAR(200) NOT NULL, LAST_CHECKIN_TIME BIGINT NOT NULL, CHECKIN_INTERVAL BIGINT NOT NULL);
...
ALTER TABLE DCON_QRTZ_SCHEDULER_STATE ADD PRIMARY KEY (SCHED_NAME, INSTANCE_NAME);
...
CREATE TABLE DCON_QRTZ_LOCKS (SCHED_NAME VARCHAR(120) NOT NULL, LOCK_NAME VARCHAR(40) NOT NULL);
...
ALTER TABLE DCON_QRTZ_LOCKS ADD PRIMARY KEY (SCHED_NAME, LOCK_NAME);
