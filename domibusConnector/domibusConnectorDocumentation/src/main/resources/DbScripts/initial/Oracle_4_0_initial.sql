...
CREATE TABLE DOMIBUS_WEBADMIN_USER (USERNAME VARCHAR2(128) NOT NULL, "PASSWORD" VARCHAR2(150), SALT VARCHAR2(64), ROLE VARCHAR2(20), CONSTRAINT PK_DOMIBUS_WEBADMIN_USER PRIMARY KEY (USERNAME));
...
CREATE TABLE DOMIBUS_WEBADMIN_PROPERTIES (PROPERTIES_KEY VARCHAR2(128), PROPERTIES_VALUE VARCHAR2(100));
