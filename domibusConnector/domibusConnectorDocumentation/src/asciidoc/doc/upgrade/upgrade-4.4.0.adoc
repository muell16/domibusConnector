...
* token.issuer.advanced-electronic-system-type => connector.business-document-sent.default-advancedSystem-type
* token.issuer.identity-provider => connector.business-document-sent.authentication-validation.identity-provider
* connector.security.keystore.path => connector.connector.ecodex-container.signature.key-store.path
* connector.security.keystore.password => connector.connector.ecodex-container.signature.key-store.password
* connector.security.private-key.alias => connector.connector.ecodex-container.signature.private-key.alias
* connector.security.private-key.password => connector.connector.ecodex-container.signature.private-key.password
...
** connector.connector.ecodex-container.signature-validation.trust-store.path

* connector.security.trust-store.password =>
** connector.business-document-sent.signature-validation.trust-store.password
** connector.connector.ecodex-container.signature-validation.trust-store.password
...
* Reupload p-Modes an trusted connectors keystore.
