...
* Fix for CVE-2022-46364. CXF is upgraded to 3.4.10. As therefore the xmlsec (org.apache.santuario:xmlsec) lib is also upgraded we have to override the class: eu.europa.esig.dss.xades.SantuarioInitializer from dss utils (eu.europa.ec.joinup.sd-dss:dss-xades)
...
* CVE-2022-46363 does not affect the connector because neither of the attribtues are set by cxf-spring-boot-starter-jaxws
