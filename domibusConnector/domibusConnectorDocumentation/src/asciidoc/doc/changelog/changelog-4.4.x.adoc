...
* Fix problem with selection of LinkPartner in MessageTransport View. The problem was that the selection only worked if no link partner has been selected.
