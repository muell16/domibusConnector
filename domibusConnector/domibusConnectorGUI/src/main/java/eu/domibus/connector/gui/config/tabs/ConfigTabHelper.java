...
public class ConfigTabHelper {
	...
	public static JFormattedTextField addTextFieldRow(Format format, JPanel panel, String labelValue, String tfValue, String helpText, int cols){
	...
	public static JButton addFileChooserRow(JPanel panel, String labelValue, String tfValue, String helpText, JTextField log){
