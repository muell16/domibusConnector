...
public class ConfigSecurityTab extends JPanel {
	...
	private JPanel buildSecurityPanel() {
		...
		final JFormattedTextField tokenIssuerCountry = ConfigTabHelper.addTextFieldRow(null, springPanel, ConnectorProperties.SECURITY_TOKEN_ISSUER_COUNTRY_LABEL, ConnectorProperties.tokenIssuerCountry, ConnectorProperties.SECURITY_TOKEN_ISSUER_COUNTRY_HELP, 35);
		...
		final JFormattedTextField tokenIssuerServiceProvider = ConfigTabHelper.addTextFieldRow(null, springPanel, ConnectorProperties.SECURITY_TOKEN_ISSUER_PROVIDER_LABEL, ConnectorProperties.tokenIssuerServiceProvider, ConnectorProperties.SECURITY_TOKEN_ISSUER_PROVIDER_HELP,10);
...
//		final JFormattedTextField tokenIssuerAES = ConfigTabHelper.addTextFieldRow(null, springPanel, ConnectorProperties.SECURITY_TOKEN_ISSUER_AES_LABEL, ConnectorProperties.tokenIssuerAESValue, ConnectorProperties.SECURITY_TOKEN_ISSUER_AES_HELP,10);
//		tokenIssuerAES.addPropertyChangeListener(new PropertyChangeListener() {
//			@Override
//			public void propertyChange(PropertyChangeEvent evt) {
//				ConnectorProperties.tokenIssuerAESValue = tokenIssuerAES.getText();
//			}
//		});
//		tokenIssuerAES.setEditable(ConnectorProperties.useSecurityToolkit);
		
		final JFormattedTextField implementationClassName = ConfigTabHelper.addTextFieldRow(null, springPanel, ConnectorProperties.SECURITY_IMPL_CLASSNAME_LABEL, ConnectorProperties.securityToolkitImplementationClassName, ConnectorProperties.SECURITY_IMPL_CLASSNAME_HELP,10);
