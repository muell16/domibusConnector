...
public class ConfigEvidencesTab extends JPanel {
	...
	private JPanel buildAddressPanel() {
		...
		postalAddressStreet = ConfigTabHelper.addTextFieldRow(null, addressPanel, 
				ConnectorProperties.EVIDENCES_ADDRESS_STREET_LABEL, ConnectorProperties.postalAddressStreet, ConnectorProperties.EVIDENCES_ADDRESS_STREET_HELP,40);
		...
		postalAddressLocality = ConfigTabHelper.addTextFieldRow(null, addressPanel, 
				ConnectorProperties.EVIDENCES_ADDRESS_LOCALITY_LABEL, ConnectorProperties.postalAddressLocality, ConnectorProperties.EVIDENCES_ADDRESS_LOCALITY_HELP,5);
		...
		postalAddressPostalCode = ConfigTabHelper.addTextFieldRow(null, addressPanel, 
				ConnectorProperties.EVIDENCES_ADDRESS_POSTAL_CODE_LABEL, ConnectorProperties.postalAddressPostalCode, ConnectorProperties.EVIDENCES_ADDRESS_POSTAL_CODE_HELP,5);
		...
		postalAddressCountry = ConfigTabHelper.addTextFieldRow(null, addressPanel, 
				ConnectorProperties.EVIDENCES_ADDRESS_COUNTRY_LABEL, ConnectorProperties.postalAddressCountry, ConnectorProperties.EVIDENCES_ADDRESS_COUNTRY_HELP,10);
	...
	private JPanel buildEvidencesPanel() {
		...
		relayremmdTimeout = ConfigTabHelper.addTextFieldRow(null, evidencesPanel, 
				ConnectorProperties.EVIDENCES_TIMEOUT_RELAYREMMD_LABEL, ConnectorProperties.evidenceRelayREMMDTimeout, ConnectorProperties.EVIDENCES_TIMEOUT_RELAYREMMD_HELP, 35);
		...
		deliveryTimeout = ConfigTabHelper.addTextFieldRow(null, evidencesPanel, 
				ConnectorProperties.EVIDENCES_TIMEOUT_DELIVERY_LABEL, ConnectorProperties.evidenceDeliveryTimeout, ConnectorProperties.EVIDENCES_TIMEOUT_DELIVERY_HELP, 35);
		...
		retrievalTimeout = ConfigTabHelper.addTextFieldRow(null, evidencesPanel, 
				ConnectorProperties.EVIDENCES_TIMEOUT_RETRIEVAL_LABEL, ConnectorProperties.evidenceRetrievalTimeout, ConnectorProperties.EVIDENCES_TIMEOUT_RETRIEVAL_HELP, 35);
