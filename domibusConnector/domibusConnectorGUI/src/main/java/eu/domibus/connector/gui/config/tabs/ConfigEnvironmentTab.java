...
public class ConfigEnvironmentTab extends JPanel {
	...
	private JPanel buildDynamicDiscoveryPanel() {
		...
		final JFormattedTextField smlResolver = ConfigTabHelper.addTextFieldRow(null, dynamicDiscoveryPanel, ConnectorProperties.DYNAMIC_DISCOVERY_SML_RESOLVER_LABEL, ConnectorProperties.dynamicDiscoverySMLResolverAddress, ConnectorProperties.DYNAMIC_DISCOVERY_SML_RESOLVER_HELP, 35);
		...
		final JFormattedTextField community = ConfigTabHelper.addTextFieldRow(null, dynamicDiscoveryPanel, ConnectorProperties.DYNAMIC_DISCOVERY_COMMUNITY_LABEL, ConnectorProperties.dynamicDiscoveryCommunity, ConnectorProperties.DYNAMIC_DISCOVERY_COMMUNITY_HELP,10);
		...
		final JFormattedTextField environment = ConfigTabHelper.addTextFieldRow(null, dynamicDiscoveryPanel, ConnectorProperties.DYNAMIC_DISCOVERY_ENVIRONMENT_LABEL, ConnectorProperties.dynamicDiscoveryEnvironment, ConnectorProperties.DYNAMIC_DISCOVERY_ENVIRONMENT_HELP,10);
		...
		final JFormattedTextField normalisation = ConfigTabHelper.addTextFieldRow(null, dynamicDiscoveryPanel, ConnectorProperties.DYNAMIC_DISCOVERY_NORM_ALGORITHM_LABEL, ConnectorProperties.dynamicDiscoveryNormalisationAlgorithm, ConnectorProperties.DYNAMIC_DISCOVERY_NORM_ALGORITHM_HELP,10);
	...
	private JPanel buildProxyConfigPanel() {
		...
		final JFormattedTextField proxyHost = ConfigTabHelper.addTextFieldRow(null, proxyConfigPanel, ConnectorProperties.PROXY_HOST_LABEL, ConnectorProperties.proxyHost, ConnectorProperties.PROXY_HOST_HELP, 50);
		...
		final JFormattedTextField proxyPort = ConfigTabHelper.addTextFieldRow(null, proxyConfigPanel, ConnectorProperties.PROXY_PORT_LABEL, ConnectorProperties.proxyPort, ConnectorProperties.PROXY_PORT_HELP,10);
		...
		final JFormattedTextField proxyUsername = ConfigTabHelper.addTextFieldRow(null, proxyConfigPanel, ConnectorProperties.PROXY_USERNAME_LABEL, ConnectorProperties.proxyUser, ConnectorProperties.PROXY_USERNAME_HELP,10);
		...
		final JFormattedTextField proxyPassword = ConfigTabHelper.addTextFieldRow(null, proxyConfigPanel, ConnectorProperties.PROXY_PASSWORD_LABEL, ConnectorProperties.proxyPassword, ConnectorProperties.PROXY_PASSWORD_HELP,10);
	...
	private JPanel buildGeneralConfigPanel() {
		...
		final JFormattedTextField checkMessagesPeriod = ConfigTabHelper.addTextFieldRow(null, generalConfigPanel, 
				ConnectorProperties.GENERAL_CHECK_MESSAGES_PERIOD_LABEL, ConnectorProperties.checkMessagesPeriod, ConnectorProperties.GENERAL_CHECK_MESSAGES_PERIOD_HELP, 40);
	...
	private JPanel buildGwConfigPanel() {
		...
		final JFormattedTextField gatewayEndpoint = ConfigTabHelper.addTextFieldRow(null, gwConfigPanel, ConnectorProperties.GATEWAY_ENDPOINT_LABEL, ConnectorProperties.gatewayEndpointValue, ConnectorProperties.GATEWAY_ENDPOINT_HELP, 40);
		...
		final JFormattedTextField gatewayName = ConfigTabHelper.addTextFieldRow(null, gwConfigPanel, ConnectorProperties.GATEWAY_NAME_LABEL, ConnectorProperties.gatewayNameValue, ConnectorProperties.GATEWAY_NAME_HELP,10);
		...
		final JFormattedTextField gatewayRole = ConfigTabHelper.addTextFieldRow(null, gwConfigPanel, ConnectorProperties.GATEWAY_ROLE_LABEL, ConnectorProperties.gatewayRoleValue, ConnectorProperties.GATEWAY_ROLE_HELP,10);
