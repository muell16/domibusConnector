...
public class DomibusConnectorMessageExceptionBuilder {
    ...
    private DC5MessageId messageId;
    ...
    public DomibusConnectorMessageExceptionBuilder setMessage(DC5Message message) {
        this.message = message;
        return this;
    }

    public DomibusConnectorMessageExceptionBuilder setMessage(DC5MessageId message) {
