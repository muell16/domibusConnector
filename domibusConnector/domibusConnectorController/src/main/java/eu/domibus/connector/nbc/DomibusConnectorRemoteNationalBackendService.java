...
/**
 * 
 * former NationalBackendClientInterface
 * 
 * renamed to make clear this interface is for implementing the (web)service which is communicating
 * over network to the configured/registered nationalbackend implementations
 * 
 * 
 * 
 */
public interface DomibusConnectorRemoteNationalBackendService {
     ...
     */
    public void deliverMessage(DomibusConnectorMessage message) throws DomibusConnectorNationalBackendClientException,
     ...
     * @throws ImplementationMissingException
     */
    public void deliverLastEvidenceForMessage(DomibusConnectorMessage confirmationMessage)
     ...
     * @throws ImplementationMissingException
     */
    public void requestMessage(DomibusConnectorMessage message) throws DomibusConnectorNationalBackendClientException,
            ImplementationMissingException;
     ...
     * @throws ImplementationMissingException
     */
    public DomibusConnectorMessage[] requestConfirmations() throws DomibusConnectorNationalBackendClientException,
            ImplementationMissingException;
     ...
     * @throws ImplementationMissingException
     */
    public String requestMessageStatusFromGateway(DomibusConnectorMessage message)
            throws DomibusConnectorNationalBackendClientException, ImplementationMissingException;
     ...
     * @throws ImplementationMissingException
     */
    public List<DomibusConnectorMessage> requestMessageErrors(DomibusConnectorMessage message)
            throws DomibusConnectorNationalBackendClientException, ImplementationMissingException;
}
