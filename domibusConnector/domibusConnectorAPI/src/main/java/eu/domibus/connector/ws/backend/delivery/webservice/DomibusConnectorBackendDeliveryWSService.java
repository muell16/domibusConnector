 ...
 * 2018-03-01T09:43:04.757+01:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "DomibusConnectorBackendDeliveryWSService", 
                  wsdlLocation = "file:/C:/Entwicklung/repos/connector/domibusConnector/domibusConnectorAPI/src/main/resources/wsdl/DomibusConnectorBackendDeliveryWebService.wsdl",
...
public class DomibusConnectorBackendDeliveryWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Entwicklung/repos/connector/domibusConnector/domibusConnectorAPI/src/main/resources/wsdl/DomibusConnectorBackendDeliveryWebService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DomibusConnectorBackendDeliveryWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Entwicklung/repos/connector/domibusConnector/domibusConnectorAPI/src/main/resources/wsdl/DomibusConnectorBackendDeliveryWebService.wsdl");
        }
        WSDL_LOCATION = url;
    }
