 ...
 * 2018-03-01T09:43:04.895+01:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "DomibusConnectorBackendWSService", 
                  wsdlLocation = "file:/C:/Entwicklung/repos/connector/domibusConnector/domibusConnectorAPI/src/main/resources/wsdl/DomibusConnectorBackendWebService.wsdl",
...
public class DomibusConnectorBackendWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Entwicklung/repos/connector/domibusConnector/domibusConnectorAPI/src/main/resources/wsdl/DomibusConnectorBackendWebService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DomibusConnectorBackendWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Entwicklung/repos/connector/domibusConnector/domibusConnectorAPI/src/main/resources/wsdl/DomibusConnectorBackendWebService.wsdl");
        }
        WSDL_LOCATION = url;
    }
