 ...
 * 2018-03-01T09:43:04.614+01:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "DomibusConnectorGatewaySubmissionWSService", 
                  wsdlLocation = "file:/C:/Entwicklung/repos/connector/domibusConnector/domibusConnectorAPI/src/main/resources/wsdl/DomibusConnectorGatewaySubmissionWebService.wsdl",
...
public class DomibusConnectorGatewaySubmissionWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Entwicklung/repos/connector/domibusConnector/domibusConnectorAPI/src/main/resources/wsdl/DomibusConnectorGatewaySubmissionWebService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DomibusConnectorGatewaySubmissionWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Entwicklung/repos/connector/domibusConnector/domibusConnectorAPI/src/main/resources/wsdl/DomibusConnectorGatewaySubmissionWebService.wsdl");
        }
        WSDL_LOCATION = url;
    }
