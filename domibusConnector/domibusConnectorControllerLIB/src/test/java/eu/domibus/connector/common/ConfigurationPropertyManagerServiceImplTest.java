...
public class ConfigurationPropertyManagerServiceImplTest {
    ...
    private static final Logger LOGGER = LogManager.getLogger(ConfigurationPropertyManagerServiceImplTest.class);
    ...
    @Autowired
    ConfigurationPropertyManagerServiceImpl propertyLoaderService;
