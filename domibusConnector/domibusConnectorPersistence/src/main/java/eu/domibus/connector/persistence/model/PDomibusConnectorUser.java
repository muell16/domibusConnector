...
public class PDomibusConnectorUser {
    ...
    @Id
    @TableGenerator(name = "seqStoreUser", table = "DOMIBUS_CONNECTOR_SEQ_STORE", pkColumnName = "SEQ_NAME", pkColumnValue = "DOMIBUS_CONNECTOR_USER.ID", valueColumnName = "SEQ_VALUE", initialValue = 1, allocationSize = 1)
