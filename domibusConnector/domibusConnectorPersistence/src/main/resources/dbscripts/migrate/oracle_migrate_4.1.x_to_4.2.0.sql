...
INSERT INTO DC_PMODE_SET (ID, FK_MESSAGE_LANE, CREATED, DESCRIPTION) VALUES (1, 1, sysdate, 'initial set created by migration script');

ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE_INFO DROP CONSTRAINT FK_DC_MSG_INFO_1;
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE_INFO DROP CONSTRAINT FK_DC_MSG_INFO_2;
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE_INFO DROP CONSTRAINT FK_DC_MSG_INFO_3;
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE_INFO DROP CONSTRAINT FK_DC_MSG_INFO_4;

ALTER TABLE DOMIBUS_CONNECTOR_BACK_2_S DROP CONSTRAINT FK_DC_BACK2S_02;
