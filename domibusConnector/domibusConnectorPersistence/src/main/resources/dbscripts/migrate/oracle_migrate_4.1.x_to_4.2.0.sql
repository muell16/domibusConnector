...
create table DC_LINK_CONFIGURATION (
	...
	CONFIG_NAME VARCHAR(255) not null constraint UNQ_DC_LINK_CONFIG_NMAE unique,
...
alter table DOMIBUS_CONNECTOR_MSG_CONT ADD COLUMN STORAGE_REFERENCE_ID VARCHAR2(512);
alter table DOMIBUS_CONNECTOR_MSG_CONT ADD COLUMN DIGEST VARCHAR2(512);
alter table DOMIBUS_CONNECTOR_MSG_CONT ADD COLUMN PAYLOAD_NAME VARCHAR2(512);
alter table DOMIBUS_CONNECTOR_MSG_CONT ADD COLUMN PAYLOAD_IDENTIFIER VARCHAR2(512);
alter table DOMIBUS_CONNECTOR_MSG_CONT ADD COLUMN PAYLOAD_DESCRIPTION CLOB;
alter table DOMIBUS_CONNECTOR_MSG_CONT ADD COLUMN PAYLOAD_MIMETYPE VARCHAR2(255);
...
ALTER TABLE DOMIBUS_CONNECTOR_PARTY ADD COLUMN IDENTIFIER VARCHAR2(255);

CREATE SEQUENCE temp_seq start with 1;
ALTER TABLE DOMIBUS_CONNECTOR_PARTY ADD COLUMN FK_PMODE_SET DECIMAL(10,0);
ALTER TABLE DOMIBUS_CONNECTOR_PARTY ADD COLUMN ID DECIMAL(10, 0) NOT NULL default temp_seq.nextval;
ALTER TABLE DOMIBUS_CONNECTOR_PARTY MODIFY COLUMN ID DECIMAL(10,0) NOT NULL default NULL;
...
ALTER TABLE DOMIBUS_CONNECTOR_ACTION ADD COLUMN ID DECIMAL(10, 0) NOT NULL default temp_seq.nextval;
ALTER TABLE DOMIBUS_CONNECTOR_ACTION MODIFY COLUMN ID DECIMAL(10,0) NOT NULL default NULL;
...
ALTER TABLE DOMIBUS_CONNECTOR_SERVICE ADD COLUMN ID DECIMAL(10, 0) NOT NULL default temp_seq.nextval;
ALTER TABLE DOMIBUS_CONNECTOR_SERVICE MODIFY COLUMN ID DECIMAL(10,0) NOT NULL default NULL;
...
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE_INFO MODIFY (COLUMN ORIGINAL_SENDER VARCHAR2(2048));
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE_INFO MODIFY (COLUMN FINAL_RECIPIENT VARCHAR2(2048));
