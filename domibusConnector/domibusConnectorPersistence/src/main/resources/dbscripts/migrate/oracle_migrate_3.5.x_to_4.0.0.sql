...
(
    ...
    BACKEND_KEY_PASS     VARCHAR2(255) NOT NULL,
...
ALTER TABLE DOMIBUS_CONNECTOR_MESSAGE_INFO ADD CONSTRAINT FK_DC_MSG_INFO_3 foreign key (FROM_PARTY_ID, FROM_PARTY_ROLE) references DOMIBUS_CONNECTOR_PARTY;
