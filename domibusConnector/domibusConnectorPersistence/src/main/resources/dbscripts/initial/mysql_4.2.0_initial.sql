...
CREATE TABLE DOMIBUS_CONNECTOR_SEQ_STORE (SEQ_NAME VARCHAR(255) NOT NULL, SEQ_VALUE DECIMAL(10, 0) NOT NULL);
...
CREATE TABLE DOMIBUS_CONNECTOR_ACTION (ACTION VARCHAR(255) NOT NULL, PDF_REQUIRED DECIMAL(1, 0) NOT NULL);
